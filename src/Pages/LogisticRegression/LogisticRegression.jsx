...
export default class LogisticRegression extends Component {
	...
	axios.post("http://127.0.0.1:5000/logistic_regression/", null,{ params: {
		percenatgeTraining,
			shouldShuffle,
			normalizeData,
			opColNo,
		...
		return(
			<div className='app-body'>
				...
				<div className='dark-background main-content-size'>
					<div className='main-content-header'>Logistic Regresion</div>
					...
					<div className="ui inverted segment" style={{ margin: '0px' }}>
						...
						{
							!trainingPossible
							? <span style={{ color: 'tomato' }}>Select data source to activte next options</span>
						...
						? <>
								...
								<br/>
								{
									trainingData.confusion_matrix.length === 2
									? 
										<>
